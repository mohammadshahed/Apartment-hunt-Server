...
// Root API
app.get("/", (req, res) => {
  res.send("Welcome to the apartment Hunt server");
});

// MongoDB Connect
const uri = `mongodb+srv://apartmenthunt:aIwpJXgOtmCEgMgV@cluster0.sgixs.mongodb.net/apartmentHunt?retryWrites=true&w=majority`;
